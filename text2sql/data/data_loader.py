...
# from fedml.data.fednlp.base.data_manager.base_data_manager import BasenDataManager
...
from spider_data_manager import SpiderDataManager
...
def load_synthetic_data(args):
    ...
    dm = SpiderDataManager(args, args.client_num_per_round)
    # train_data_num, train_data_global, test_data_global, train_data_local_num_dict, \
    # train_data_local_dict, test_data_local_dict, num_clients = dm.load_federated_data(process_id=args.process_id)
    (
        train_data_num,
        test_data_num,
        train_data_global,
