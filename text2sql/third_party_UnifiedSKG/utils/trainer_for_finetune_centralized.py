...
import sys
sys.path.append("..")
from from_transformer_source.trainer_seq2seq import Seq2SeqTrainerFinetuneCentralized
...
class EvaluateFriendlySeq2SeqTrainer(Seq2SeqTrainerFinetuneCentralized):
    def __init__(
            self,
            evaluator,
