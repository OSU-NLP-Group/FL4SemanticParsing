...
# from third_party_UnifiedSKG.from_transformer_source.trainer_seq2seq import Seq2SeqTrainer
import sys
sys.path.append("..")
# print(sys.path)
# from from_transformer_source.trainer_seq2seq import Seq2SeqTrainer
from text2sql.third_party_UnifiedSKG.from_transformer_source.trainer_seq2seq import Seq2SeqTrainer
...
class EvaluateFriendlySeq2SeqTrainerSetGPU(Seq2SeqTrainer):
    def __init__(
            self,
            fl_algorithm,
            fedprox_mu,
        ...
        super().__init__(fl_algorithm,fedprox_mu,device, *args, **kwargs)
        self.evaluator = evaluator
        # self.device = device
        self.eval_examples = eval_examples
        self.compute_metrics = self._compute_metrics
