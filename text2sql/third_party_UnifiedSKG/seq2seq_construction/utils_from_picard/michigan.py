...
class TrainDataset(Dataset):
    def __init__(self, args, raw_datasets, cache_root):
        ...
        # cache_path = os.path.join(cache_root, 'question_split_atis_train.cache')
        cache_path = os.path.join(cache_root, 'question_split_' + self.args.dataset.data_name +'_train.cache')
        # import pdb
        # pdb.set_trace()
...
class DevDataset(Dataset):
    def __init__(self, args, raw_datasets, cache_root):
        ...
        # cache_path = os.path.join(cache_root, 'question_split_atis_dev.cache')
        cache_path = os.path.join(cache_root, 'question_split_' + self.args.dataset.data_name +'_dev.cache')
        if os.path.exists(cache_path) and args.dataset.use_cache:
            self.extended_data = torch.load(cache_path)
        else:
            self.extended_data = []
...
class TestDataset(Dataset):
    def __init__(self, args, raw_datasets, cache_root):
        ...
        # cache_path = os.path.join(cache_root, 'question_split_atis_test.cache')
        cache_path = os.path.join(cache_root, 'question_split_' + self.args.dataset.data_name +'_test.cache')
        if os.path.exists(cache_path) and args.dataset.use_cache:
            self.extended_data = torch.load(cache_path)
        else:
            self.extended_data = []
