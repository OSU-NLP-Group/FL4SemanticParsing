    ...
    def __init__(self, args, raw_datasets, cache_root):
        ...
        if os.path.exists(cache_path) and args.dataset.use_cache:
            ...
            for raw_data in tqdm(self.raw_datasets):
                ...
                extend_data.update(spider_add_serialized_schema(extend_data, args.seq2seq))
    ...
    def __init__(self, args, raw_datasets, cache_root):
        ...
        if os.path.exists(cache_path) and args.dataset.use_cache:
            ...
            for raw_data in tqdm(self.raw_datasets):
                ...
                question, seq_out = spider_pre_process_one_function(extend_data, args=self.args.seq2seq)
                extend_data.update({"struct_in": extend_data["serialized_schema"].strip(),
                                    "text_in": question,
                                    "seq_out": seq_out})
                self.extended_data.append(extend_data)
