...
class EvaluateTool(object):
    ...
    def evaluate(self, preds, golds, section):
        ...
        for arg_path, preds_golds in wait_for_eval.items():
            ...
            # evaluator = third_party_UnifiedSKG.utils.tool.get_evaluator(args.evaluate.tool)(args)

            temp_args = Configure.refresh_args_by_file_cfg(os.path.join(meta_args.dir.configure, arg_path), meta_args)
            evaluator = third_party_UnifiedSKG.utils.tool.get_evaluator(temp_args.evaluate.tool)(temp_args)
