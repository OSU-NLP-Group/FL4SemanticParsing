...
import datasets
from third_party_UnifiedSKG.metrics.michigan.official_evaluation import compute_metrics, compute_one_metric
...
class Michigan(datasets.Metric):
    def __init__(
        self,
...
class EvaluateTool(object):
    ...
    def evaluate(self, preds, golds, section):
        ...
        # print(self.args.test_suite_db_dir)
        # import json
        # with open("")cd
        # print(preds[0])
        # print(golds[0])
        ...
        # test_suite = compute_test_suite_metric(preds, golds)
         # return {**exact_match, **test_suite}

        # two_metrics = compute_metrics(golds, preds)
        # return {**two_metrics}

        one_metric = compute_one_metric(golds, preds)
        return {**one_metric}
